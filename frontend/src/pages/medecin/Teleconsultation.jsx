...
export default function MedecinTeleconsultation() {
  ...
  return (
    <Layout title="Téléconsultation">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-slate-900">Salles de téléconsultation</h2>
        <p className="text-sm text-slate-500">Consultations vidéo avec vos patients confirmés.</p>
      </div>
      ...
      {active ? (
        <div className="space-y-4">
          ...
          <p className="text-sm text-slate-600">
            Patient : <strong>{active.rendez_vous?.patient?.user?.name}</strong>
          </p>
          <JitsiMeet
        ...
        <div className="rounded-2xl border border-dashed bg-white p-12 text-center">
          ...
          <p className="mt-3 font-medium text-slate-700">Aucune téléconsultation à venir</p>
        </div>
      ) : (
